...
function createCard(task) {
  $('#todos').prepend(`<article class="new-task" id=${task.id}>
    <div class = "card-top">
      ...
      <button type="button" class="delete-btn" value="delete task"></button>
    </div>
    <div class = "card-middle">
      <p class="task-body" name="task-body" contenteditable>${task.body}</p>
    </div>
    <div class = "card-bottom">
      <button type="button" class="up-btn" value="increase importance button" name="up-button"></button>
      <button type="button" class="down-btn" name="down-button" value="decrease importance button"></button>
